...
export function Providers({ children }: { children: ReactNode }) {
  ...
  const [extendedVariantsAndColors, setExtendedVariantsAndColors] = useState<object>(initialVal);

  return (
    <AppSlotsProvider value={{ extendedVariantsAndColors, setExtendedVariantsAndColors, newVariant, setNewVariant }}>
      <ThemeProvider attribute="class">
        <Provider extendVariantAndColorStyles={{ variants: { variant: newVariant }, compoundVariants: extendedVariantsAndColors }}>
          {children}
        </Provider>
      </ThemeProvider>
    </AppSlotsProvider>
